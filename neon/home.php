...
<nav class="navbar navbar-expand-lg bg-dark">
  <div class="container-fluid">
    ...
    <p>Vous souhaitez faire un design particulier, vous avez une idée bien précise en tête ? Super, vous êtes au bon endroit ! Répondez au formulaire ci-dessous avec le plus de précisions possible sur votre futur néon sur-mesure, et nous vous enverrons un devis dans les 24h</p>
    <a class="a" href="#">
        <span></span>
        <span></span>
        <span></span>
...
<div class="section2">
  ...
  <div class="grsection">
    ...
    <p>Lorsque vous tenez un commerce, avoir un néon possède quelques avantages : il attire l'oeil, il fait donc entrer plus de clientèle et peut inconsciemment avoir un impact sur votre chiffre d'affaires</p>
    <a class="a" href="#">
        <span></span>
        <span></span>
        <span></span>
