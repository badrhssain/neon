...
<body>
    <div class="littlelogin">
      <a href="home.php"><img class="logo" src="neon logo a.png"></a>
        ...
        <input type ="nom" name="email" class="email" placeholder="Nom" required><br>
        <input type ="prenom" name="email" class="email" placeholder="Prenom" required><br>
        <input type ="emai" name="email" class="email" placeholder="Adresse E-mail" required><br>
        <input type ="password" name="password" class="password" placeholder="Adresse" required><br>
        <input type ="text" name="email" class="email" placeholder="Numero de tel" required><br>
        <input type ="password" name="password" class="password" placeholder="Mot de passe" required><br>
       <a class="a" href="#">
        <span></span>
        <span></span>
        <span></span>
